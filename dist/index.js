...
var TaskListHeaderDefault = function TaskListHeaderDefault(_ref) {
  ...
  }, "To"), React__default.createElement("div", {
    className: styles.ganttTable_HeaderSeparator,
    style: {
      height: headerHeight * 0.5,
      marginTop: headerHeight * 0.2
    }
  }), (isShown === null || isShown === void 0 ? void 0 : isShown.duration) && React__default.createElement("div", {
    className: styles.ganttTable_HeaderItem,
    style: {
      minWidth: rowWidth,
      textAlign: 'center'
  ...
  }), (isShown === null || isShown === void 0 ? void 0 : isShown.progress) && React__default.createElement("div", {
    className: styles.ganttTable_HeaderItem,
    style: {
      minWidth: rowWidth,
      textAlign: 'center'
    }
  }, "Progress"), (isShown === null || isShown === void 0 ? void 0 : isShown.estimatedCost) && React__default.createElement("div", {
    className: styles.ganttTable_HeaderItem,
    style: {
      minWidth: rowWidth,
      textAlign: 'center'
    }
  }, "Estimated Cost"), (isShown === null || isShown === void 0 ? void 0 : isShown.actualCost) && React__default.createElement("div", {
    className: styles.ganttTable_HeaderItem,
    style: {
      minWidth: rowWidth,
      textAlign: 'center'
...
var TaskListTableDefault = function TaskListTableDefault(_ref) {
  ...
  var updateTimer = function updateTimer(taskId) {
    var updatedElement = React__default.cloneElement(rightSideElement, {
      'taskId': taskId,
      'fetchData': fetchData,
      'locale': locale
    });
  ...
  var updateStartDatePicker = function updateStartDatePicker(taskId) {
    var updatedElement = React__default.cloneElement(dateTimeStartComponent, {
      'taskId': taskId
    });
    return updatedElement;
  };
  ...
  return React__default.createElement("div", {
    ...
    }, t.name), !expanderSymbol && React__default.createElement("div", {
      style: {
        margin: "0px",
        position: "absolute",
        width: "50%",
    ...
    }, "\xA0", updateTimer(t.id))))), React__default.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth,
    ...
    }, updateStartDatePicker(t.id)), React__default.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth,
    ...
    }, updateEndDatePicker(t.id)), (isShown === null || isShown === void 0 ? void 0 : isShown.duration) && React__default.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth,
    ...
    }, "\xA0", !expanderSymbol && calculateTimeDifference(t.start, t.end)), (isShown === null || isShown === void 0 ? void 0 : isShown.progress) && React__default.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth,
    ...
    }, t === null || t === void 0 ? void 0 : t.estimated_cost), (isShown === null || isShown === void 0 ? void 0 : isShown.actualCost) && React__default.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth,
