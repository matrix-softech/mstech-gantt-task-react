...
var TaskListHeaderDefault = function TaskListHeaderDefault(_ref) {
  ...
  }), (isShown === null || isShown === void 0 ? void 0 : isShown.duration) && React.createElement("div", {
    className: styles.ganttTable_HeaderItem,
    style: {
      minWidth: rowWidth,
      textAlign: 'center'
  ...
  }), (isShown === null || isShown === void 0 ? void 0 : isShown.progress) && React.createElement("div", {
    className: styles.ganttTable_HeaderItem,
    style: {
      minWidth: rowWidth,
      textAlign: 'center'
    }
  }, "Progress"), (isShown === null || isShown === void 0 ? void 0 : isShown.estimatedCost) && React.createElement("div", {
    className: styles.ganttTable_HeaderItem,
    style: {
      minWidth: rowWidth,
      textAlign: 'center'
    }
  }, "Estimated Cost"), (isShown === null || isShown === void 0 ? void 0 : isShown.actualCost) && React.createElement("div", {
    className: styles.ganttTable_HeaderItem,
    style: {
      minWidth: rowWidth,
      textAlign: 'center'
...
var calculateTimeDifference = function calculateTimeDifference(startDate, endDate, unit) {
  if (unit === void 0) {
    unit = 'days';
  }
  ...
  if (unit === 'hours') {
    var diffInHours = Math.floor(diffInMs / 3600000);
    return diffInHours + "h";
  } else {
    var diffInDays = Math.floor(diffInMs / (3600000 * 24));
    return diffInDays + "d";
  }
};
...
var TaskListTableDefault = function TaskListTableDefault(_ref) {
  ...
  var _useState = useState({}),
      hoveredTasks = _useState[0],
      setHoveredTasks = _useState[1];

  var handleMouseEnter = function handleMouseEnter(taskId) {
    setHoveredTasks(function (prevState) {
      var _extends2;

      return _extends({}, prevState, (_extends2 = {}, _extends2[taskId] = true, _extends2));
    });
  };

  var handleMouseLeave = function handleMouseLeave(taskId) {
    setHoveredTasks(function (prevState) {
      var _extends3;

      return _extends({}, prevState, (_extends3 = {}, _extends3[taskId] = false, _extends3));
    });
  };

  var updateTimer = function updateTimer(taskId) {
    var updatedElement = React.cloneElement(rightSideElement, {
      'taskId': taskId,
      'fetchData': fetchData,
      'locale': locale
    });
  ...
  var updateStartDatePicker = function updateStartDatePicker(taskId) {
    var updatedElement = React.cloneElement(dateTimeStartComponent, {
      'taskId': taskId
    });
    return updatedElement;
  };
  ...
  var updateEndDatePicker = function updateEndDatePicker(taskId) {
    var updatedElement = React.cloneElement(dateTimeEndComponent, {
      'taskId': taskId
    });
    return updatedElement;
  };
  ...
  return React.createElement("div", {
    ...
    return React.createElement("div", {
      ...
      onMouseEnter: function onMouseEnter() {
        return handleMouseEnter(t.id);
      },
      onMouseLeave: function onMouseLeave() {
        return handleMouseLeave(t.id);
      }
    }, React.createElement("div", {
    ...
    }, t.name), !expanderSymbol && React.createElement("div", {
      style: {
        margin: "0px",
        position: "absolute",
        width: "50%",
    ...
    }, "\xA0", updateTimer(t.id))))), React.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth,
    ...
    }, updateStartDatePicker(t.id)), React.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth,
    ...
    }, updateEndDatePicker(t.id)), (isShown === null || isShown === void 0 ? void 0 : isShown.duration) && React.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth,
    ...
    }, "\xA0", !expanderSymbol && calculateTimeDifference(t.start, t.end)), (isShown === null || isShown === void 0 ? void 0 : isShown.progress) && React.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth,
    ...
    }, "\xA0"), t.progress < 60 && React.createElement("div", {
      style: {
        position: 'absolute',
        top: '0px',
        left: '0px',
    ...
    }, t.progress > 0 ? t.progress : '0', "%"), t.progress >= 60 && React.createElement("div", {
      style: {
        position: 'absolute',
        top: '0px',
        left: '0px',
    ...
    }, t.progress > 0 ? t.progress : '0', "%"))), (isShown === null || isShown === void 0 ? void 0 : isShown.estimatedCost) && React.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth,
    ...
    }, t === null || t === void 0 ? void 0 : t.estimated_cost), (isShown === null || isShown === void 0 ? void 0 : isShown.actualCost) && React.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth,
    ...
    }, t === null || t === void 0 ? void 0 : t.actual_cost));
  }));
};
...
var Gantt = function Gantt(_ref) {
  var tasks = _ref.tasks,
      ...
      _ref$taskWidth = _ref.taskWidth,
      taskWidth = _ref$taskWidth === void 0 ? 150 : _ref$taskWidth,
      ...
      dateTimeEndComponent = _ref$dateTimeEndCompo === void 0 ? [] : _ref$dateTimeEndCompo,
      _ref$isShown = _ref.isShown,
      isShown = _ref$isShown === void 0 ? {} : _ref$isShown,
      _ref$fetchData = _ref.fetchData,
      fetchData = _ref$fetchData === void 0 ? function () {
    return;
  } : _ref$fetchData,
      _ref$onClickTask = _ref.onClickTask,
      onClickTask = _ref$onClickTask === void 0 ? function () {
    return;
  } : _ref$onClickTask,
      onDateChange = _ref.onDateChange,
      onProgressChange = _ref.onProgressChange,
